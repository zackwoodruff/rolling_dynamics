...
if param.options.is_fast_dynamics
    ...
    matlabFunction(subs(param.kinematics.second_order_kinematics_,param.bodies.P_,param.bodies.P),...
        'File',[export_directory '\functions\autoGen_f_second_order_kinematics'],'Optimize',is_optimize,...
        'Outputs', {'dYdt'}, 'Vars',{t_,qdq_,param.variables.Alpha_});
    
    % Pure Rolling Constraint
    matlabFunction(param.kinematics.alpha_z_pr_,'File',[export_directory '\functions\autoGen_f_alpha_z_pure_rolling'],...
    'Optimize',is_optimize,'Vars',{qdq_});
    
    % Hand Dynamics
    matlabFunction(param.dynamics.dxddx_hand,'file',[export_directory, '\functions\autoGen_f_hand_dynamics'],...
        'Optimize',is_optimize,'Vars',{t_, states_hand_, controls_});
    
    % Object Dynamics
    matlabFunction(param.dynamics.K5_,'File',[export_directory '\functions\autoGen_f_K5'],...
        'Optimize',is_optimize,'Vars',{q_});
    matlabFunction(param.dynamics.K6_,'File',[export_directory '\functions\autoGen_f_K6'],...
        'Optimize',is_optimize,'Vars',{states_});
    matlabFunction(param.dynamics.Ad_Toh_,'File',[export_directory '\functions\autoGen_f_Ad_Toh'],...
        'Optimize',is_optimize,'Vars',{q_});
    
else
    % Full object and hand dynamics 
    matlabFunction(param.dynamics.full_dynamics_,...
        'file', [export_directory, '\functions\autoGen_f_full_dynamics'],...
        'Vars', {t_, states_, controls_});
    
    matlabFunction(param.dynamics.F_contact_,...
        'file', [export_directory, '\functions\autoGen_f_F_contact'],...
